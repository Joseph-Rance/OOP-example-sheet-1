...
class Count {
  ...
  public String toString() {
    return String.format("%s(D=%f, W=%f)", handRank, dealProbability, winProbability);
  }
  ...
  public boolean equals(Object o) {
    ...
    Count count = (Count) o;
    return handRank == count.handRank
            && dealProbability.equals(count.dealProbability)
            && winProbability.equals(count.winProbability);
  }
