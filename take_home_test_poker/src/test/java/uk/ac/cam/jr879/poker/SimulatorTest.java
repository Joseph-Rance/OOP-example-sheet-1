...
import static uk.ac.cam.jr879.poker.Card.Suit.CLUBS;
import static uk.ac.cam.jr879.poker.Card.Suit.DIAMONDS;
import static uk.ac.cam.jr879.poker.Card.Suit.HEARTS;
import static uk.ac.cam.jr879.poker.Card.Suit.SPADES;
import static uk.ac.cam.jr879.poker.Card.Value.ACE;
import static uk.ac.cam.jr879.poker.Card.Value.EIGHT;
import static uk.ac.cam.jr879.poker.Card.Value.FIVE;
import static uk.ac.cam.jr879.poker.Card.Value.FOUR;
import static uk.ac.cam.jr879.poker.Card.Value.JACK;
import static uk.ac.cam.jr879.poker.Card.Value.KING;
import static uk.ac.cam.jr879.poker.Card.Value.QUEEN;
import static uk.ac.cam.jr879.poker.Card.Value.SIX;
import static uk.ac.cam.jr879.poker.Card.Value.TEN;
import static uk.ac.cam.jr879.poker.Card.Value.THREE;
import static uk.ac.cam.jr879.poker.Card.Value.TWO;
...
public class SimulatorTest {
  ...
  public void simulate_countsDealtHands_inFiveRounds() {
    ...
    assertThat(tabulated)
        .containsAtLeast(
            new Count(HandRank.ROYAL_FLUSH, 0.2, 1),
