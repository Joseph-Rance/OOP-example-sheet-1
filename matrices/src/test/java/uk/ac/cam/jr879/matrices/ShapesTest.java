...
public class ShapesTest {
  ...
  @Test
  public void square_isCorrect_for2x2() {
    // ARRANGE

    // ACT
    Matrix m = Shapes.square(5);

    // ASSERT
    assertThat(m.get(0, 0)).isWithin(1e-7).of(5);
    assertThat(m.get(0, 1)).isWithin(1e-7).of(5);
    assertThat(m.get(0, 2)).isWithin(1e-7).of(-5);
    assertThat(m.get(0, 3)).isWithin(1e-7).of(-5);
    assertThat(m.get(1, 0)).isWithin(1e-7).of(5);
    assertThat(m.get(1, 1)).isWithin(1e-7).of(-5);
    assertThat(m.get(1, 2)).isWithin(1e-7).of(-5);
    assertThat(m.get(1, 3)).isWithin(1e-7).of(5);
  }
  ...
  @Test
  public void rotation2d_isCorrect_for2x2() {
    // ARRANGE
    ...
    // ASSERT
    assertThat(m.get(0, 0)).isWithin(1e-7).of(Math.pow(2,-0.5));
    assertThat(m.get(1, 0)).isWithin(1e-7).of(Math.pow(2,-0.5));

    assertThat(m.get(0, 1)).isWithin(1e-7).of(-Math.pow(2,-0.5));
    assertThat(m.get(1, 1)).isWithin(1e-7).of(Math.pow(2,-0.5));
  }
}
